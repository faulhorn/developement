//Autor: Philipp Husi, Programme aus verschiedenen Quellen vereint und angepasst.

/*******************************************************************************
 * Programm 1, für Datenversendung mit LoRa:
 * 
 ...
 *******************************************************************************/
 ...
 /*****************************************************************************
  * Programm 2 für Auslesung eines DS18B20 Tempsensors:
  * 
...
void do_send(osjob_t* j){
    ...
    sprintf(mydata, "%f", tempC);
    Serial.print("payload mydata= ");
...
//    pinMode(13, OUTPUT); 
    ...
    Serial.println(F("Starting LoRa Setup and Dallas Temperature IC Control Library Demo"));
