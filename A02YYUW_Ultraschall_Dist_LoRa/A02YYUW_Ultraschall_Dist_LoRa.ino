 ...
 *******************************************************************************/
 ...
 /*
  * Hier folgen zuerst die Libraries, Deklarationen, Initialisierungen usw. für das LoRa Programm und dann diejenigen für die Sensorauslesung.
  * LoRa:
  */
...
float d= 0.0;
static uint8_t mydata[] = "Distance: " + d + "cm"; //mydata[] wird deklariert und initialisiert
...
void do_send(osjob_t* j){ //Hier wird die Nachricht versendet.
    
//__________________________________________________________________________________   
    //Hier erstmal den Sensor / die Sensoren auslesen:
        do{ 
          for(int i=0;i<4;i++) { 
